...
for name in names:
    ...
    i = 0
    for AI in df_raw.AI:
        kRs_G.append(0.3648 - 0.0099*(df_raw.Tmax.values[i] - df_raw.Tmin.values[i]) + 0.0194*2 - 0.0017*df_raw.RH.values[i])
        i = i + 1
    ...
    for AI in df_raw.AI:
        if AI >= 1.00:
            kRs_CF.append(float(0.5191 - 0.0104*(df_raw.Tmax.values[j] - df_raw.Tmin.values[j]) + 0.0188*2 - 0.0035*df_raw.RH.values[j]))
        if 0.65<=AI<1:
            kRs_CF.append(float(0.3958 - 0.0105*(df_raw.Tmax.values[j] - df_raw.Tmin.values[j]) + 0.0186*2 - 0.0021*df_raw.RH.values[j]))
        if 0.20<=AI<0.65:
            kRs_CF.append(float(0.3880 - 0.0095*(df_raw.Tmax.values[j] - df_raw.Tmin.values[j]) + 0.0224*2 - 0.0022*df_raw.RH.values[j]))
        if AI<0.20:
            kRs_CF.append(float(0.2169 - 0.0042*(df_raw.Tmax.values[j] - df_raw.Tmin.values[j]) + 0.0352*2 - 0.0011*df_raw.RH.values[j]))
        j = j + 1
